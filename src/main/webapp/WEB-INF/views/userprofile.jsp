...
<html>
    ...
    <body>
     <div id="mainWrapper">
        ...
        <form:form method="POST" modelAttribute="userprofile" action="/adduserprofile" class="form-horizontal">
            ...
            <div class="row">
                ...
                <div class="form-actions floatRight">
                    <c:choose>
                        <c:when test="${edit}">
                            <input type="submit" value="save" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/adduserprofile' />">Cancel</a>
                        </c:when>
                        <c:otherwise>
